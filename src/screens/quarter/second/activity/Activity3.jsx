...
const imagePath = "../../../../../assets/image/activity/act3";
...
function FirstActivity() {
  ...
  const randomizeChoices = async () => {
    ...
    try {
      const value = await AsyncStorage.getItem("@act3");
      const total = Number(value) + 1;
      if (total > 100) return;
      await AsyncStorage.setItem("@act3", JSON.stringify(total));
    } catch (e) {
      // saving error
    }
  };
      ...
      <View style={{ padding: 20, flex: 1 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 19 }}>
            Piliin ang hanay ng mga larawan na tumutugma sa bilang na lima.
          </Text>
        </View>
  ...
  const Question2 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 19 }}>
            Piliin ang hanay ng mga larawan na tumutugma sa bilang na tatlo.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices2.map((item, i) => (
  ...
  const Question3 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 19 }}>
            Piliin ang hanay ng mga larawan na tumutugma sa bilang na isa.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices3.map((item, i) => (
  ...
  const Question4 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 19 }}>
            Piliin ang hanay ng mga larawan na tumutugma sa bilang na apat.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices4.map((item, i) => (
  ...
  const Question5 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 19 }}>
            Piliin ang hanay ng mga larawan na tumutugma sa bilang na dalawa.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices5.map((item, i) => (
