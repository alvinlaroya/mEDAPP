...
const videoFile = require("./../../../../assets/videos/recognize_the_word.mp4");
...
function FirstActivity() {
  ...
  useEffect(() => {
    if (checkKey) {
      const thingToSay = "Recognize the word";
      Speech.speak(thingToSay);
    }
  }, [checkKey]);

  const submitKeyHandler = () => {
    if (actKey === "medappq4act12") {
      setCheckKey(true);
    } else {
  ...
  return checkKey ? (
    <View style={styles.container}>
      <View style={{ padding: 10 }}>
        ...
        <Text style={{ fontSize: 19 }}>Recognize the word</Text>
      </View>
      <View style={{ padding: 10 }}>
      ...
      <View style={{ padding: 10 }}>
        <Button
          ...
          buttonColor="green"
          onPress={() => navigation.navigate("Activity12")}
        >
          Start Activity
        </Button>
      </View>
