...
const videoFile = require("./../../../../assets/videos/add_and_subtract_number_sentence.mp4");
...
function FirstActivity() {
  ...
  useEffect(() => {
    if (checkKey) {
      const thingToSay = "Addition and Subtraction number sentence";
      Speech.speak(thingToSay);
    }
  }, [checkKey]);

  const submitKeyHandler = () => {
    if (actKey === "medappq4act15") {
      setCheckKey(true);
    } else {
    ...
    <View style={styles.container}>
      ...
      <View style={{ padding: 10 }}>
        <Button
          ...
          buttonColor="green"
          onPress={() => navigation.navigate("Activity15")}
        >
          Start Activity
        </Button>
      </View>
