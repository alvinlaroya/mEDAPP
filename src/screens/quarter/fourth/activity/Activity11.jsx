...
const imagePath = "../../../../../assets/image/activity/act11";
...
function FirstActivity() {
  ...
  useEffect(() => {
    const thingToSay = [
      "Ayusin ang bawat pangkat ng mga bilang mula sa mababa - mataas na pamamaraan (least to greatest). Piliin ang tamang sagot sa mga larawan.",
      "Ayusin ang bawat pangkat ng mga bilang mula sa mababa - mataas na pamamaraan (least to greatest). Piliin ang tamang sagot sa mga larawan.",
      "Ayusin ang bawat pangkat ng mga bilang mula sa mababa - mataas na pamamaraan (least to greatest). Piliin ang tamang sagot sa mga larawan.",
      "Ayusin ang bawat pangkat ng mga bilang mula sa mataas - mababa na pamamaraan (greatest to least). Piliin ang tamang sagot sa mga larawan.",
      "Ayusin ang bawat pangkat ng mga bilang mula sa mataas - mababa na pamamaraan (greatest to least). Piliin ang tamang sagot sa mga larawan.",
    ];
      ...
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Ayusin ang bawat pangkat ng mga bilang mula sa mababa - mataas na
            pamamaraan (least to greatest). Piliin ang tamang sagot sa mga
            larawan.
          </Text>
          <Image
  ...
  const Question4 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Ayusin ang bawat pangkat ng mga bilang mula sa mataas - mababa na
            pamamaraan (greatest to least). Piliin ang tamang sagot sa mga
            larawan.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
  ...
  const Question5 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            5. Ayusin ang bawat pangkat ng mga bilang mula sa mataas - mababa na
            pamamaraan (greatest to least). Piliin ang tamang sagot sa mga
            larawan.
          </Text>
        </View>
