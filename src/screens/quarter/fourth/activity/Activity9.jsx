...
function FirstActivity() {
  ...
  const [choices1, setChoices1] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>12 hours</Text>
      </View>
    </TouchableHighlight>,
    <TouchableHighlight
      underlayColor="#0099ff"
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>24 hours</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const [choices2, setChoices2] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>6 hours</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const [choices3, setChoices3] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>Clock</Text>
      </View>
    </TouchableHighlight>,
    <TouchableHighlight
      underlayColor="#0099ff"
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>TV</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const [choices4, setChoices4] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>30 minutes</Text>
      </View>
    </TouchableHighlight>,
    <TouchableHighlight
      underlayColor="#0099ff"
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>60 minutes</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const [choices5, setChoices5] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>O'clock</Text>
      </View>
    </TouchableHighlight>,
    <TouchableHighlight
      underlayColor="#0099ff"
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>Minutes</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const randomizeChoices = async () => {
    ...
    try {
      const value = await AsyncStorage.getItem("@act9");
      const total = Number(value) + 1;
      if (total > 100) return;
      await AsyncStorage.setItem("@act9", JSON.stringify(total));
    } catch (e) {
      // saving error
    }
  };
      ...
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Ilang oras ang meron sa isang araw?
          </Text>
        </View>
  ...
  const Question2 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Ilan ang oras pag daytime at nighttime?
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices2.map((item, i) => (
    ...
    return (
      <View style={{ padding: 20, flex: 1 }}>
        <View
          style={{ padding: 20, borderBottomWidth: 1, borderColor: "black" }}
        >
          <Text style={{ fontSize: 19 }}>Paano naten malalaman ang oras?</Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices3.map((item, i) => (
            <View key={i}>{item}</View>
  ...
  const Question4 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Ilang minuto ang meron sa isang oras?e
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
          {choices4.map((item, i) => (
  ...
  const Question5 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Ano ang sinasabi naten kapag ang mahabang kamay ng orasan ay nasa
            12?
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
