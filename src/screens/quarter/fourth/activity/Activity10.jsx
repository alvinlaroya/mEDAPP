...
const imagePath = "../../../../../assets/image/activity/act10";
...
function FirstActivity() {
  ...
  const [choices1, setChoices1] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>11</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const [choices3, setChoices3] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>13</Text>
      </View>
    </TouchableHighlight>,
    <TouchableHighlight
      underlayColor="#0099ff"
  ...
  const [choices5, setChoices5] = useState([
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>12</Text>
      </View>
    </TouchableHighlight>,
    <TouchableHighlight
      underlayColor="#0099ff"
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "bold" }}>15</Text>
      </View>
    </TouchableHighlight>,
  ]);
  ...
  const randomizeChoices = async () => {
    ...
    try {
      const value = await AsyncStorage.getItem("@act10");
      const total = Number(value) + 1;
      if (total > 100) return;
      await AsyncStorage.setItem("@act10", JSON.stringify(total));
    } catch (e) {
      // saving error
    }
  };
  ...
  const Question4 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Piliin ang tamang sagot na naglalaman ng kasunod na bilang na 1, 2,
            3, _______.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
  ...
  const Question5 = (props) => {
    return (
      <View style={{ padding: 20, flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 19 }}>
            Piliin ang tamang sagot na naglalaman ng kasunod na bilang na 9, 10,
            11, _______.
          </Text>
        </View>
        <View style={[styles.container, { padding: 20 }]}>
